...
namespace WebBHDT.Areas.Admin.Controllers
{
    public class SanPhamController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaSP,TenSP,DonGia,NgayCapNhap,Mota,HinhAnh,MaNSX,MaLoaiSP,DaXoa,HinhAnh1,HinhAnh2,HinhAnh3,HinhAnh4,SoLuong,Tinhtrang")] SanPham sanPham)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaSP,TenSP,DonGia,NgayCapNhap,Mota,HinhAnh,MaNSX,MaLoaiSP,DaXoa,HinhAnh1,HinhAnh2,HinhAnh3,HinhAnh4,SoLuong,Tinhtrang")] SanPham sanPham)
        {
            if (ModelState.IsValid)
            {
